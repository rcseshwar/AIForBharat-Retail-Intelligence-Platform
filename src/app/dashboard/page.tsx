    ...
    return (
      <div className="flex items-center justify-center min-h-[400px]">
        <div className="text-center">
          ...
          <p className="text-gray-600 dark:text-gray-400 mb-4">Please go back to the home page and enter your OpenAI API key.</p>
          <button 
            onClick={() => router.push('/')}
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <div className="bg-white dark:bg-gray-800 p-6 rounded-lg border dark:border-gray-700">
          ...
          <p className="text-2xl font-bold text-blue-600 dark:text-blue-400">$125,000</p>
        ...
        <div className="bg-white dark:bg-gray-800 p-6 rounded-lg border dark:border-gray-700">
          ...
          <p className="text-2xl font-bold text-orange-600 dark:text-orange-400">850</p>
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg border dark:border-gray-700 p-6">
        ...
        <div className="space-y-3">
          <div className="flex items-start space-x-3">
            ...
            <div>
              <p className="text-sm font-medium text-gray-900 dark:text-white">Try natural language queries</p>
